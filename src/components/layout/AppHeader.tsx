...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-20 bg-surface-container/98 backdrop-blur-xl border-b border-outline-variant/20 ios-safe-top ios-safe-left ios-safe-right elevation-2">
      {/* new: constrain width and match content container */}
