...
import { useNewAdminStationManagement } from "./stations/NewAdminStationManagement";
import { useToast } from "@/hooks/use-toast";
import { Badge } from "@/components/ui/badge";

interface NewAdminStationsManagerProps {
  onSave: (stations: any[]) => void;
  onCancel: () => void;
}

const NewAdminStationsManager: React.FC<NewAdminStationsManagerProps> = ({ onSave, onCancel }) => {
...
export default NewAdminStationsManager;
