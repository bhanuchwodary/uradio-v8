 ...
 */
export const createHlsConfig = () => {
  // Define the configuration object with its properties explicitly typed
  const config: Hls.Config = {
    ...
    // Using proper configuration without namespace references
  };
